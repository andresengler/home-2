  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className={`${geistSans.variable} font-sans text-[15px] text-gray-600 dark:text-gray-300 leading-relaxed mt-4`}>
      ...
      <div className="space-y-4">
        {writings.map((yearGroup) => (
          <div key={yearGroup.year} className="space-y-4 mb-4">
            <h3 className={`${azeretMono.className} text-[12px] font-normal tracking-tight text-[#C5B6B6] dark:text-[#C5B6B6] mb-2`}>
              {yearGroup.year}
            </h3>
                  ...
                  >
                    <div className="flex items-center justify-between py-1">
                      <div className="flex-1 pr-4">
                        <motion.h4 
                          className={`${geistSans.variable} font-sans text-[15px] font-medium transition-all duration-200 ${
                      ...
                      <div className="flex items-center">
                        <span className={`${azeretMono.className} text-gray-400 dark:text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity text-[0.7em]`}>
                          ↗
                        </span>
                      </div>
                    </div>
